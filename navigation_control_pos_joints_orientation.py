...
email = "teslacoil358@gmail.com"  #"kornbot380@hotmail.com"
project_name = "BD3"  #bd3  #Forklift #teslacoil358@gmail.com
...
def control_robot():
    ...
    payload = {email: {project_name: {
        ...
        "robot_name": "Forklift_AMR_01"  #"Robot_arm_01"  # Add or update this field for dynamic label
    }}}
    try:
